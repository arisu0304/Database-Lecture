...
CREATE TABLE SCORE_CHK(
	...
	CNO VARCHAR2(8),
	RESULT NUMBER(3,0),
	CONSTRAINT CHK_SCORE_CHK_RESULT
		CHECK(RESULT BETWEEN 60 AND 90)
);
...
CREATE TABLE COURSE_CONTSRAINT(
	CNO VARCHAR2(8),
	CNAME VARCHAR2(20),
	ST_NUM NUMBER(2,1) DEFAULT 2,
	PNO NUMBER(4,0) REFERENCES PROFESSOR_PK(PNO),
	CONSTRAINT PK_COURSE_CONTSRAINT_CNO_CNAME
