...
CREATE TABLE COURSE_PK (
	CNO VARCHAR2(8) CONSTRAINT COURSE_PK PRIMARY KEY,
	CNAME VARCHAR2(20),
	ST_NUM NUMBER(1,0),
	PNO VARCHAR2(8)
);
...
CREATE TABLE T_BOARD(
	BOARD_NO NUMBER CONSTRAINT PK_T_BOARD_NO PRIMARY KEY,
...
CREATE TABLE T_BOARD_FILE(
	...
	CONSTRAINT PK_T_BOARD_FILE_NO_FILE_NO PRIMARY KEY(BOARD_NO, BOARD_FILE_NO)
);
...
CREATE TABLE T_SNS_DETAIL(
	...
	CONSTRAINT FK_T_SNS_DETAIL_NO
		FOREIGN KEY(SNS_NO) REFERENCES T_SNS(SNS_NO)
);
...
CREATE TABLE  T_SNS_UPLOADED(
	...
	CONSTRAINT FK_T_SNS_UPLOADED_NO
		FOREIGN KEY(SNS_UPL_NO) REFERENCES T_SNS(SNS_NO)
);
