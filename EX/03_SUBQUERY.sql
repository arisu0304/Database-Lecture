...
-- UNION은 중복을 제거한 합집합
-- 평점이 3.0 이상인 학생의 학생번호, 학생이름, 학년, 평점과
...
-- 2-2. 차집합 연산자(MINUS)
-- 첫번째 쿼리에서 두번째 쿼리와 공통된 데이터를 제외한 결과를 조회
INSERT INTO EMP VALUES('9998', '제갈궁', '지원', NULL,
					SYSDATE, 3200, 320, NULL);
COMMIT;
	
--성이 제갈이면서 지원업무를 하지 않는 사람의 사원번호, 사원이름, 업무 조회
...
-- 차집합 연산자를 사용해서 담당교수가 배정되지 않은 과목의 
-- 과목번호, 과목이름 조회
...
-- 교집합 연산자를 써서 물리, 화학과 학생중 평점이 3.0이상인 학생의
-- 학생번호, 학생이름, 전공, 평점 조회
